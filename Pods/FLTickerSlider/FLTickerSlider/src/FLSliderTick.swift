...
//        tickerView.frame = CGRect(offset,
//                                      sliderHeight / 2 - self.height / 2,
//                                      self.width,
//                                      self.height)
        tickerView.frame = CGRect(x: offset, y: sliderHeight / 2 - self.height / 2, width: self.width, height: self.height)
    ...
    public func setColor (color:UIColor) {
        self.color = color
        mytickerView.backgroundColor = self.color
    }
